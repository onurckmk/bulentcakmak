                            ...
                            <div class="col-12 col-lg-5 auth-side d-none d-lg-flex">
                                <div class="auth-side__inner">
                                    ...
                                    <div class="side-copy mt-auto">
                                        <div class="side-title">Şifre sıfırlama</div>
                                        <div class="side-sub">
                                        ...
                                        <div class="side-badges">
                                            ...
                                            <span class="badge rounded-pill text-bg-light">Mail</span>
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="auth-main p-4 p-lg-5">
                                    ...
                                    <div class="auth-head mb-4">
                                        <h2 class="auth-title">Şifre Sıfırla</h2>
                                        <p class="auth-sub">Sıfırlama linkini almak için e-posta adresini gir.</p>
                                    </div>

                                    @if (session('status'))
                                        <div class="alert alert-success border-0 mb-4" style="border-radius:14px;">
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-3">
                                            ...
                                            <button type="submit" class="btn btn-primary auth-btn">
                                                <i class="bi bi-send me-2"></i> Sıfırlama Bağlantısını Gönder
                                            </button>
                                        </div>
